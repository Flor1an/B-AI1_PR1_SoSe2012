...
class Dreieck
  ...
  #NEU: den Dreieck langsam horizontal bewegen
  ...
  #NEU: Dreieck bewegen, basierend auf der vorhandenen bewege Methode
  def bewegen(wiederholungen, x_delta, y_delta, wiederholen_nach, starten_nach)
    ...
    @spitze = @spitze + Point.new(x_delta*wiederholungen,y_delta*wiederholungen)
  end
