...
class Kreis
  ...
  #NEU: den Kreis langsam horizontal bewegen
  ...
  #NEU: Kreis bewegen, basierend auf der vorhandenen bewege Methode
  def bewegen(wiederholungen, x_delta, y_delta, wiederholen_nach, starten_nach)
    ...
    @mittelpunkt = @mittelpunkt + Point.new(x_delta*wiederholungen,y_delta*wiederholungen)
  end
