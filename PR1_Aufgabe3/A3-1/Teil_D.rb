...
class Matrix
  ...
  # Skalarprodukt einer n*m Matrix mit einem Spaltenvektor der Länge m.
  ...
  # Multipliziert eine n*m Matrix mit eine m*k Matrix
  # das Ergebnis ist eine n*k Matrix
  # die Elemente in der n*k Matrix res[i][l] werden berechnet, indem
...
inst = Matrix.new()
puts "multipliziere mit Vektor:"
inst.multipliziere_mit_vektor([1,2,3])
puts 
puts
puts "Multipliziere_mit_matrix"
